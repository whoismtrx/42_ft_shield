...
int main()
{
	...
	char	msg[] = 	{0x50, 0x13, 0x78, 0x66, 0xDA, 0xE9, 0x99, 0x8E, 0xEB, 0x57, 0x0F, 0x0E, 0xDD, 0xDF, 0x36, 0xB6, 0x5B, 0xF3, 0x57,
									 0x15, 0x2F, 0x22, 0x58, 0xCE, 0x4A, 0xBB, 0x30, 0x4A, 0x2D, 0xF7, 0x39, 0x66, 0x4A, 0xE7, 0x3C};
	// printf("%s\n", msg);
